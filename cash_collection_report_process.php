...
$results      = find_cash_by_dates($start_date,$end_date);
...
<body>
    ...
    <div class="page-break">
      ...
      <table class="table table-border">
        ...
        <tbody>
          ...
          ?>
           ...
           <tr>
              ...
              <td class="text-center"><b><?php echo remove_junk(ucfirst($result['name']));?></b></td>
              ...
              <td class="text-right"><?php echo remove_junk($result['return_sale']);?></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
        <tr>
          ...
          <td class="text-right"><font color=""><b> Rs.<?php echo number_format($return_sale_total, 2);?></b></font></td>
        </tr>
        <tr>
          <td></td>
          <td class="text-center"><b>Total Sale</b></td>
          <td class="text-right"><font color=""><b> Rs.<?php echo number_format($cash_total+$credit_total+$cheque_total+$return_sale_total, 2);?></b></font></td>
        </tr>
      </tfoot>
      </table>
    </div>
  <?php
        ...
        redirect('cash_collection_report.php', false);
     endif;
  ?>
</body>
</html>
